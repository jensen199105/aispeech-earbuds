...
typedef enum tagWINDINFO
{
    WIND_OUT = 0,   /* Quiet environment by default, corresponding to thresh in env. */
    WIND_IN  = 1,   /* Wind noise environment, corresponding to thresh_wind in env. */
} tagWINDINFO_E;
...
S8   *GSC_Version(VOID);
S32   GSC_WindCbRegister(GSC_Api_S *pstGscApi, void *pvHandler, void *pvData);
