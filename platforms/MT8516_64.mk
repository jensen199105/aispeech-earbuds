...
CHAINDIR        = /Projects/MTK8516/ali/oecore-x86_64/sysroots/x86_64-oesdk-linux/usr/bin/aarch64-poky-linux/
...
CFLAGS         += -mcpu=cortex-a72.cortex-a53+crypto -mtune=cortex-a72.cortex-a53
CFLAGS         += --sysroot=${CHAINDIR}../../../../aarch64-poky-linux
